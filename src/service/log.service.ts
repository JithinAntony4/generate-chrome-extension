...
export class LogService {
    ...
    showIntro(): void {
        ...
        console.log(yellow(`More info: ${cyan('https://github.com/JithinAntony4/generate-chrome-extension')}`));
        console.log('---------------------------------------------------------------');
    ...
    showHelp(projectName: string): void {
        ...
        console.log(`       Press ${yellow('Load unpacked')} and target the folder '${bold('build')}'`);

        console.log();
        console.log(`   ${cyan('npm run pack')}`);
